...
import com.aptpod.auth.Authentication;
import com.aptpod.auth.HttpBasicAuth;
import com.aptpod.auth.HttpBearerAuth;
import com.aptpod.auth.ApiKeyAuth;
import com.aptpod.auth.OAuth;
import com.aptpod.auth.RetryingOAuth;
import com.aptpod.auth.OAuthFlow;
...
public class ApiClient {
    ...
    private String basePath = "https://example.intdash.jp/api";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://example.intdash.jp/api",
      "URLのサンプルです。",
    ...
    public ApiClient() {
        ...
        authentications.put("BasicAuthForTenantAPI", new HttpBasicAuth());
        authentications.put("IntdashToken", new ApiKeyAuth("header", "X-Intdash-Token"));
        authentications.put("OAuth2", new OAuth());
        authentications.put("OAuth2", new OAuth());
        authentications.put("OAuth2", new OAuth());
        authentications.put("OAuth2TokenInHeader", new HttpBearerAuth("bearer"));
        authentications.put("OAuth2TokenInCookie", new ApiKeyAuth("cookie", "_bearer_token"));
    ...
    public ApiClient(String basePath, String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        String tokenUrl = "/api/auth/oauth2/token";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/v2.4.0-next-4a4316946/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://example.intdash.jp/api
     ...
     * @return a {@link com.aptpod.ApiClient} object
     */
     ...
     * @throws com.aptpod.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.aptpod.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.aptpod.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.aptpod.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.aptpod.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.aptpod.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.aptpod.ApiException If fails to update the parameters
     */
     ...
     * @throws com.aptpod.ApiException If fail to serialize the request body object into a string
     */
