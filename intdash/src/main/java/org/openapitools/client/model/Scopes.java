...
public class Scopes {
  ...
  private List<Scope> items = new ArrayList<>();
  ...
  public Scopes items(List<Scope> items) {
    
    this.items = items;
    return this;
  }

  public Scopes addItemsItem(Scope itemsItem) {
    if (this.items == null) {
  ...
  **/
  ...
  public Scopes page(AuthPage page) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.items, scopes.items) &&
        Objects.equals(this.page, scopes.page)&&
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Scopes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : Scopes.openapiRequiredFields) {
      ...
      for (int i = 0; i < jsonArrayitems.size(); i++) {
        Scope.validateJsonObject(jsonArrayitems.get(i).getAsJsonObject());
      };
