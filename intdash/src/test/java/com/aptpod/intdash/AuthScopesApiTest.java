...
/**
 * API tests for AuthScopesApi
 */
@Disabled
public class AuthScopesApiTest {

    private final AuthScopesApi api = new AuthScopesApi();
     ...
     */
    @Test
    public void getScopeTest() throws ApiException {
        String scopeUuid = null;
        Scope response = api.getScope(scopeUuid);
    ...
    public void listScopesTest() throws ApiException {
        ...
        Scopes response = api.listScopes(uuid, name, page, perPage);
        // TODO: test validations
    }
